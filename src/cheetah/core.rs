...
///
/// Note that `active_scene` is a copy of one of the scenes, it's not a direct reference. This is because things will change within `active_scene`, which
/// we will likely not want to persist into the array of scenes.
